 ...
 * The {@link String} value of the argument will then be converted using the {@link PositionalArgument#adaper} is needed.
 */
@Documented
...
public @interface PositionalArgument {
     ...
     */
    Class<? extends ArgumentValueAdapter> adaper() default DefaultArgumentValueAdapter.class;
}
